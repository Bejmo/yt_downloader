...
def descargar_audio_youtube(yt, destino, actualizar):
    ...
    try: # Soluciona error de tener un nombre raro y no detectarlo con yt.title en "actualizar_playlist"
        ...
        if (actualizar == 1):
            print("Actualizando. Añadiendo: ", name_file, "\n")
        else:
            print("Descargando: ", name_file, "\n")
    except:
        os.remove(out_file)
...
def actualizar_playlist(playlist, destino):
    ...
    print("Se está actualizando, espere unos instantes.\n")
    for yt in playlist.videos:
        name_file = yt.title + '.mp3'
...
def main():
    ...
    if (1 <= respuesta and respuesta <= 4):
        ...
        try:    
            ...
            print("Solicitud completada correctamente.\n")
        
        except:
            print("Se ha producido un error. Inténtelo más tarde.\n")

    else:
        print("El número introducido es inválido. Inténtelo más tarde.\n")
